...
export default component$(() => {
  ...
  return (
    <div class="card">
      <div class="card__visual"><b class="price">S$49,000</b></div>
      <div class="card_detail">
        <h3>513 The Calrose</h3>
        <p>513 Tio Chu Kang Road, Singapore 787066</p>
        <div class="card_detail_features">
          <p class="card_detail_features_icons">
